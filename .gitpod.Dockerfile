...
ENV FLUTTER_HOME=/home/gitpod/flutter \
    FLUTTER_VERSION=1.22.0-12.3.pre-beta
...
# Install Flutter sdk
RUN cd /home/gitpod && \
  wget -qO flutter_sdk.tar.xz https://storage.googleapis.com/flutter_infra/releases/beta/linux/flutter_linux_${FLUTTER_VERSION}.tar.xz && \
